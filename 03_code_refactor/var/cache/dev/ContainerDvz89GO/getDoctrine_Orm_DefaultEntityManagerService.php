...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver([(\dirname(__DIR__, 4).'/src/Leadtech/Infrastructure/User/Infrastructure/Mapping') => 'Leadtech\\Domain\\User\\Entity'], '.orm.xml', true);
        $c->setGlobalBasename('mapping');

        $b->addDriver($c, 'Leadtech\\Domain\\User\\Entity');

        $a->setEntityNamespaces(['Customer' => 'Leadtech\\Domain\\User\\Entity']);
